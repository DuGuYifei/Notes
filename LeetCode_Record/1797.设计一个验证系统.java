 ...
 * [1797] 设计一个验证系统
 *
 * https://leetcode-cn.com/problems/design-authentication-manager/description/
 *
 * algorithms
 * Medium (57.09%)
 * Likes:    32
...
class AuthenticationManager {
    ...
    private HashMap<String, Integer> ttmap = new HashMap<>();
    private int res;
    ...
    public void generate(String tokenId, int currentTime) {
        ttmap.put(tokenId, currentTime + timeToLive);
    }
    
    public void renew(String tokenId, int currentTime) {
        if(ttmap.getOrDefault(tokenId, 0) > currentTime)
            ttmap.put(tokenId, currentTime + timeToLive);
    }
