...
- [2. 智能体系统分类法 (A Taxonomy of Agentic Systems)](#2-智能体系统分类法-a-taxonomy-of-agentic-systems)
  - [2.1. 第 0 级：核心推理系统 (Level 0: Core Reasoning System)](#21-第-0-级核心推理系统-level-0-core-reasoning-system)
  - [2.2. 第 1 级：连接式问题解决者 (Level 1: Connected Problem Solver)](#22-第-1-级连接式问题解决者-level-1-connected-problem-solver)
  - [2.3. 第 2 级：战略性问题解决者 (Level 2: Strategic Problem Solver)](#23-第-2-级战略性问题解决者-level-2-strategic-problem-solver)
  - [2.4. 第 3 级：协作多智能体系统 (Level 3: Collaborative Multi-Agent System)](#24-第-3-级协作多智能体系统-level-3-collaborative-multi-agent-system)
  - [2.5. 第 4 级：自我演化系统 (Level 4: Self-Evolving System)](#25-第-4-级自我演化系统-level-4-self-evolving-system)
- [3. 核心智能体架构：模型、工具和编排 (Core Agent Architecture: Model, Tools, and Orchestration)](#3-核心智能体架构模型工具和编排-core-agent-architecture-model-tools-and-orchestration)
  - [3.1. 模型：你的 AI 智能体的“大脑” (Model: The Brain of Your AI Agent)](#31-模型你的-ai-智能体的大脑-model-the-brain-of-your-ai-agent)
  - [3.2. 工具：你的 AI 智能体的“双手” (Tools: The Hands of Your AI Agent)](#32-工具你的-ai-智能体的双手-tools-the-hands-of-your-ai-agent)
    - [3.2.1. 检索信息：根植于现实 (Retrieving Information: Grounded in Reality)](#321-检索信息根植于现实-retrieving-information-grounded-in-reality)
    - [3.2.2. 执行动作：改变世界 (Executing Actions: Changing the World)](#322-执行动作改变世界-executing-actions-changing-the-world)
    - [3.2.3. 函数调用：将工具连接到你的智能体 (Function Calling: Connecting Tools to Your Agent)](#323-函数调用将工具连接到你的智能体-function-calling-connecting-tools-to-your-agent)
  - [3.3. 编排层 (Orchestration Layer)](#33-编排层-orchestration-layer)
    - [3.3.1. 核心设计选择 (Core Design Choices)](#331-核心设计选择-core-design-choices)
    - [3.3.2. 使用领域知识和角色进行指导 (Instruct with Domain Knowledge and Persona)](#332-使用领域知识和角色进行指导-instruct-with-domain-knowledge-and-persona)
    - [3.3.3. 使用上下文增强 (Augment with Context)](#333-使用上下文增强-augment-with-context)
    - [3.3.4. 多智能体系统和设计模式 (Multi-Agent Systems and Design Patterns)](#334-多智能体系统和设计模式-multi-agent-systems-and-design-patterns)
  - [3.4. 智能体部署和服务 (Agent Deployment and Services)](#34-智能体部署和服务-agent-deployment-and-services)
  - [3.5. AgentOps：应对不可预测性的结构化方法 (AgentOps: A Structured Apporach to the Unpredictable)](#35-agentops应对不可预测性的结构化方法-agentops-a-structured-apporach-to-the-unpredictable)
    - [3.5.1. 衡量真正重要的事项：像 A/B 实验一样检测成功 (Measure What Matters: Instrumenting Success Like an A/B Experiment)](#351-衡量真正重要的事项像-ab-实验一样检测成功-measure-what-matters-instrumenting-success-like-an-ab-experiment)
    - [3.5.2. 关注质量而非通过/失败：使用 LM 裁判 (Quality Instead of Pass/Fail: Using a LM Judge)](#352-关注质量而非通过失败使用-lm-裁判-quality-instead-of-passfail-using-a-lm-judge)
    - [3.5.3. 指标驱动开发：部署的 Go/No-Go 判断 (Metrics-Driven Development: Your Go/No-Go for Deployment)](#353-指标驱动开发部署的-gono-go-判断-metrics-driven-development-your-gono-go-for-deployment)
    - [3.5.4. 使用 OpenTelemetry 追踪进行调试：回答“为什么？” (Debug with OpenTelemetry Traces: Answering "Why?")](#354-使用-opentelemetry-追踪进行调试回答为什么-debug-with-opentelemetry-traces-answering-why)
    - [3.5.5. 珍视人类反馈：指导你的自动化 (Cherish Human Feedback: Guiding Your Automation)](#355-珍视人类反馈指导你的自动化-cherish-human-feedback-guiding-your-automation)
  - [3.6. 智能体互操作性 (Agent Interoperability)](#36-智能体互操作性-agent-interoperability)
    - [3.6.1. 智能体与人类 (Agents and Humans)](#361-智能体与人类-agents-and-humans)
    - [3.6.2. 智能体与智能体 (Agents and Agents)](#362-智能体与智能体-agents-and-agents)
    - [3.6.3. 智能体与金钱 (Agents and Money)](#363-智能体与金钱-agents-and-money)
  - [3.7. 保护单个智能体：信任权衡 (Securing a Single Agent: The Trust Trade-off)](#37-保护单个智能体信任权衡-securing-a-single-agent-the-trust-trade-off)
    - [3.7.1. 智能体身份：一种新的主体类别 (Agent Identity: A New Class of Principal)](#371-智能体身份一种新的主体类别-agent-identity-a-new-class-of-principal)
    - [3.7.2. 用于约束访问的策略 (Policies to Constrain Access)](#372-用于约束访问的策略-policies-to-constrain-access)
    - [3.7.3. 保护 ADK 智能体 (Securing an ADK Agent)](#373-保护-adk-智能体-securing-an-adk-agent)
  - [3.8. 从单个智能体扩展到企业级智能体舰队 (Scaling Up from a Single Agent to an Enterprise Fleet)](#38-从单个智能体扩展到企业级智能体舰队-scaling-up-from-a-single-agent-to-an-enterprise-fleet)
    - [3.8.1. 安全与隐私：加固智能体前沿 (Security and Privacy: Hardening the Agentic Frontier)](#381-安全与隐私加固智能体前沿-security-and-privacy-hardening-the-agentic-frontier)
    - [3.8.2. 智能体治理：用控制平面替代蔓延 (Agent Governance: A Control Plane instead of Sprawl)](#382-智能体治理用控制平面替代蔓延-agent-governance-a-control-plane-instead-of-sprawl)
    - [3.8.3. 成本与可靠性：基础设施基础 (Cost and Reliability: The Infrastructure Foundation)](#383-成本与可靠性基础设施基础-cost-and-reliability-the-infrastructure-foundation)
  - [3.9. 智能体如何演化和学习 (How Agents Evolve and Learn)](#39-智能体如何演化和学习-how-agents-evolve-and-learn)
    - [3.9.1. 智能体如何学习和自我演化 (How Agents Learn and Self Evolve)](#391-智能体如何学习和自我演化-how-agents-learn-and-self-evolve)
      - [3.9.1.1. 示例：学习新的合规指南 (Example: Learning New Compliance Guidelines)](#3911-示例学习新的合规指南-example-learning-new-compliance-guidelines)
    - [3.9.2. 模拟与智能体训练场：下一个前沿 (Simulation and Agent Gym - the Next Frontier)](#392-模拟与智能体训练场下一个前沿-simulation-and-agent-gym---the-next-frontier)
- [4. 高级智能体示例 (Examples of Advanced Agents)](#4-高级智能体示例-examples-of-advanced-agents)
  - [4.1. Google 协同科学家 (Google Co-Scientist)](#41-google-协同科学家-google-co-scientist)
  - [4.2. AlphaEvolve 智能体 (AlphaEvolve Agent)](#42-alphaevolve-智能体-alphaevolve-agent)
- [5. 结论 (Conclusion)](#5-结论-conclusion)


## 1. AI 智能体简介 (Introduction to AI Agents)
...
### 1.1. 智能体式问题解决过程 (The Agentic Problem-Solving Process)
...
### 2.3. 第 2 级：战略性问题解决者 (Level 2: Strategic Problem Solver)
...
### 2.4. 第 3 级：协作多智能体系统 (Level 3: Collaborative Multi-Agent System)

The Collaborative Multi-Agent System.

智能体将其他智能体视为工具。

### 2.5. 第 4 级：自我演化系统 (Level 4: Self-Evolving System)
...
## 3. 核心智能体架构：模型、工具和编排 (Core Agent Architecture: Model, Tools, and Orchestration)

### 3.1. 模型：你的 AI 智能体的“大脑” (Model: The Brain of Your AI Agent)
...
### 3.2. 工具：你的 AI 智能体的“双手” (Tools: The Hands of Your AI Agent)

它们使智能体能够超越其静态训练数据，检索实时信息并对世界采取行动。一个健壮的工具接口是一个三部分循环：定义工具能做什么、调用它，以及观察结果。

几种主要工具类型（有关更完整的深入探讨，请参阅本系列中以智能体工具为重点的白皮书。）：

#### 3.2.1. 检索信息：根植于现实 (Retrieving Information: Grounded in Reality)
...
#### 3.2.2. 执行动作：改变世界 (Executing Actions: Changing the World)
...
#### 3.2.3. 函数调用：将工具连接到你的智能体 (Function Calling: Connecting Tools to Your Agent)
...
#### 3.3.1. 核心设计选择 (Core Design Choices)
...
#### 3.3.2. 使用领域知识和角色进行指导 (Instruct with Domain Knowledge and Persona)
...
#### 3.3.3. 使用上下文增强 (Augment with Context)
...
#### 3.3.4. 多智能体系统和设计模式 (Multi-Agent Systems and Design Patterns)
...
### 3.4. 智能体部署和服务 (Agent Deployment and Services)
...
### 3.5. AgentOps：应对不可预测性的结构化方法 (AgentOps: A Structured Apporach to the Unpredictable)
...
#### 3.5.1. 衡量真正重要的事项：像 A/B 实验一样检测成功 (Measure What Matters: Instrumenting Success Like an A/B Experiment)
...
#### 3.5.2. 关注质量而非通过/失败：使用 LM 裁判 (Quality Instead of Pass/Fail: Using a LM Judge)
...
#### 3.5.3. 指标驱动开发：部署的 Go/No-Go 判断 (Metrics-Driven Development: Your Go/No-Go for Deployment)
...
#### 3.5.4. 使用 OpenTelemetry 追踪进行调试：回答“为什么？” (Debug with OpenTelemetry Traces: Answering "Why?")
...
#### 3.5.5. 珍视人类反馈：指导你的自动化 (Cherish Human Feedback: Guiding Your Automation)
...
### 3.6. 智能体互操作性 (Agent Interoperability)

智能体互操作性

连接智能体与连接智能体和数据及 API 是有区别的；智能体不是工具。

#### 3.6.1. 智能体与人类 (Agents and Humans)
...
#### 3.6.2. 智能体与智能体 (Agents and Agents)
...
### 3.7. 保护单个智能体：信任权衡 (Securing a Single Agent: The Trust Trade-off)
...
#### 3.7.1. 智能体身份：一种新的主体类别 (Agent Identity: A New Class of Principal)
...
#### 3.7.2. 用于约束访问的策略 (Policies to Constrain Access)
...
#### 3.7.3. 保护 ADK 智能体 (Securing an ADK Agent)
...
### 3.8. 从单个智能体扩展到企业级智能体舰队 (Scaling Up from a Single Agent to an Enterprise Fleet)
...
#### 3.8.1. 安全与隐私：加固智能体前沿 (Security and Privacy: Hardening the Agentic Frontier)
...
#### 3.8.2. 智能体治理：用控制平面替代蔓延 (Agent Governance: A Control Plane instead of Sprawl)
...
#### 3.8.3. 成本与可靠性：基础设施基础 (Cost and Reliability: The Infrastructure Foundation)
...
### 3.9. 智能体如何演化和学习 (How Agents Evolve and Learn)
...
#### 3.9.1. 智能体如何学习和自我演化 (How Agents Learn and Self Evolve)
...
##### 3.9.1.1. 示例：学习新的合规指南 (Example: Learning New Compliance Guidelines)
...
#### 3.9.2. 模拟与智能体训练场：下一个前沿 (Simulation and Agent Gym - the Next Frontier)
...
## 4. 高级智能体示例 (Examples of Advanced Agents)

### 4.1. Google 协同科学家 (Google Co-Scientist)
...
### 4.2. AlphaEvolve 智能体 (AlphaEvolve Agent)
