...
- [记忆 (Memory)](#记忆-memory)
  - [记忆的类型 (Types of memory)](#记忆的类型-types-of-memory)
    ...
    - [创建机制 (Creation mechanisms)](#创建机制-creation-mechanisms)
    - [记忆范围 (Memory scope)](#记忆范围-memory-scope)
    - [多模态记忆 (Multimodal memory)](#多模态记忆-multimodal-memory)
  - [记忆生成：提取与整合 (Memory Generation: Extraction and Consolidation)](#记忆生成提取与整合-memory-generation-extraction-and-consolidation)
    - [深入探讨：记忆提取 (Deep-dive: Memory Extraction)](#深入探讨记忆提取-deep-dive-memory-extraction)
    - [深入探讨：记忆整合 (Deep-dive: Memory Consolidation)](#深入探讨记忆整合-deep-dive-memory-consolidation)
    - [记忆溯源 (Memory Provenance)](#记忆溯源-memory-provenance)
      - [在记忆管理中考虑记忆血缘 (Accounting for memory lineage during memory management)](#在记忆管理中考虑记忆血缘-accounting-for-memory-lineage-during-memory-management)
      - [在推理过程中考虑记忆血缘 (Accounting for memory lineage during inference)](#在推理过程中考虑记忆血缘-accounting-for-memory-lineage-during-inference)
    - [触发记忆生成 (Triggering memory generation)](#触发记忆生成-triggering-memory-generation)
      - [记忆即工具 (Memory-as-a-Tool)](#记忆即工具-memory-as-a-tool)
      - [后台操作 vs. 阻塞操作 (Background vs. Blocking Operations)](#后台操作-vs-阻塞操作-background-vs-blocking-operations)
    - [记忆检索 (Memory Retrieval)](#记忆检索-memory-retrieval)
    - [检索时机 (Timing for retrieval)](#检索时机-timing-for-retrieval)
  - [记忆推理 (Inference with Memories)](#记忆推理-inference-with-memories)
    - [系统指令中的记忆 (Memories in the System Instructions)](#系统指令中的记忆-memories-in-the-system-instructions)
    - [对话历史中的记忆 (Memories in the Conversation History)](#对话历史中的记忆-memories-in-the-conversation-history)
  - [程序性记忆 (Procedural memories)](#程序性记忆-procedural-memories)
  - [测试与评估 (Testing and Evaluation)](#测试与评估-testing-and-evaluation)
  - [记忆的生产注意事项 (Production considerations for Memory)](#记忆的生产注意事项-production-considerations-for-memory)
    - [**隐私与安全风险** (Privacy and security risks)](#隐私与安全风险-privacy-and-security-risks)
...
### 记忆生成：提取与整合 (Memory Generation: Extraction and Consolidation)
...
##### 在记忆管理中考虑记忆血缘 (Accounting for memory lineage during memory management)
...
##### 在推理过程中考虑记忆血缘 (Accounting for memory lineage during inference) 
...
### 记忆的生产注意事项 (Production considerations for Memory)
...
#### **隐私与安全风险** (Privacy and security risks)
