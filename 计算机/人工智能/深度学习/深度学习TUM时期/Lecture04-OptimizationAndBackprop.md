...
1. [Optimization and Backprop](#optimization-and-backprop)
   1. [Backprop(agation) 向后传播](#backpropagation-向后传播)
      1. [简单理解](#简单理解)
      2. [前置参数](#前置参数)
      3. [从Loss Function到带激活函数的向后传播](#从loss-function到带激活函数的向后传播)
      4. [举例](#举例)
   2. [Optimization](#optimization)
      1. [Gradient Descent](#gradient-descent)
         1. [The Flow of the Gradients](#the-flow-of-the-gradients)
            1. [图例](#图例)
               1. [对于Binary Cross Entropy Loss案例](#对于binary-cross-entropy-loss案例)
         2. [权重数量](#权重数量)
         3. [其他问题未来学习](#其他问题未来学习)
      2. [Regularization（正则化）](#regularization正则化)
         1. [over- and underfitting](#over--and-underfitting)
         2. [正则化技巧](#正则化技巧)
            1. [L1/L2 regularization](#l1l2-regularization)
               1. [L1和L2对比并举例](#l1和l2对比并举例)
         3. [目的](#目的)


## Backprop(agation) 向后传播
...
理解：
1. 和向前计算的结果无关，总是从1开始back，因为是f对f自身求导
